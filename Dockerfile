...
ENV DJANGO_SETTINGS_MODULE=geodjangoProject_Server.settings
...
RUN conda env create -n geodjangoProject_Server --file ENV.yml

## Make RUN commands use the new environment
## See https://pythonspeed.com/articles/activate-conda-dockerfile/ for explanation
RUN echo "conda activate geodjangoProject_Server" >> ~/.bashrc
...
CMD gunicorn geodjangoProject_Server.wsgi --config gunicorn.conf.py